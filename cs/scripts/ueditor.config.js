...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:HOMEURL+"picture/upload/editor/0/"             //图片上传提交地址
        ,imagePath:""                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ,imageFieldName:"editor"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ,compressSide:0                            //等比压缩的基准，确定maxImageSideLength参数的参照对象。0为按照最长边，1为按照宽度，2为按照高度
        ,maxImageSideLength:2560                    //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中
        ...
        , toolbars:[
            [
                ...
                'insertorderedlist','insertunorderedlist','|','insertimage','|','removeformat']
        ]
...
//        }
        ...
        ,initialFrameWidth:570  //初始化编辑器宽度,默认1000
        ,initialFrameHeight:130  //初始化编辑器高度,默认320
        ...
        ,initialStyle:'p{line-height:1em;font-family:微软雅黑;font-size:12px;}'//编辑器层级的基数,可以用来改变字体等
...
//           ]
        ...
        //,wordCountMsg:'<span style="font-family:微软雅黑">已输入 {#count} 个字符，还可以输入{#leave} 个字符</span>'   //当前已输入 {#count} 个字符，您还可以输入{#leave} 个字符
