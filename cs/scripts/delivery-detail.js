...
delivery.flow = function(codeID) { //@codeID
    ...
    $.ajax({
        type: "POST",
        url: "http://oc.qbao.com/express/detail.html?_merchant_user_id_="+merchant_id,
        data: {
        ...
        success: function(data) {
            ...
            if (data.msg) {
                ...
                // if (list.company.trim().length == 0) {
                //     $(".logistics-code>em:eq(1)").hide();
                //     $(".logistics-code>em:eq(2)").hide();
                //     $(".logistics-code>span:eq(1)").hide();
                //     $(".logistics-code>span:eq(2)").hide();
                // } else {
                    // $(".logistics-code>span:eq(1)").html(list.company);
                    $(".logistics-code>span:eq(1)").html($.urlParam("expressName"));
